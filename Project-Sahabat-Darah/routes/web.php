...
// RS Routes
Route::prefix('rs')->name('rs.')->middleware(['auth', 'role:admin-rs'])->group(function () {
...
// PMI Routes
Route::prefix('pmi')->name('pmi.')->middleware(['auth', 'role:admin-pmi'])->group(function () {
...
// This route is already defined above with the LoginController
...
// Register Rumah Sakit dan PMI (Ditangani oleh route /register POST)
// Route::post('/api/register-rs', [AuthController::class, 'registerRumahSakit']);
// Route::post('/api/register-pmi', [AuthController::class, 'registerPMI']);
